...
class AssessmentModel {
  ...
  // domain_data is only present on detail fetch
  ...
  factory AssessmentModel.fromJson(Map<String, dynamic> j) => AssessmentModel(
        ...
        developmentalQuotient:  (j['developmental_quotient'] as num?)?.toDouble() ?? 0,
        ...
        domainData:             j['domain_data'] as Map<String, dynamic>?,
      );
}
